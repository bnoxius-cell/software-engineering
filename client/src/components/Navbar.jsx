                        ...
                        <div className={styles.dropdown}>
                            {token ? (
                                <>
                                    ...
                                    {isAdmin && (
                                        <Link to="/admin/settings" className={styles.dropdownItem} onClick={() => setIsMenuOpen(false)}>
                                            <svg className={styles.dropdownIcon} viewBox="0 0 24 24"><path d="M12 15.5c-1.93 0-3.5-1.57-3.5-3.5s1.57-3.5 3.5-3.5 3.5 1.57 3.5 3.5-1.57 3.5-3.5 3.5zM19.43 12.98c.04-.32.07-.64.07-.98 0-.34-.03-.66-.07-.98l2.11-1.65c.19-.15.24-.42.12-.64l-2-3.46c-.12-.22-.39-.3-.61-.22l-2.49.85c-.52-.4-1.08-.73-1.69-.98l-.38-2.65C14.46 2.1 14.24 2 14 2h-4c-.24 0-.46.1-.5.33l-.38 2.65c-.61.25-1.17.59-1.69.98l-2.49-.85c-.23-.08-.5.01-.61.22l-2 3.46c-.13.22-.07.49.12.64l2.11 1.65c-.04.32-.07.65-.07.98 0 .33.03.66.07.98l-2.11 1.65c-.19.15-.24.42-.12.64l2 3.46c.12.22.39.3.61.22l2.49-.85c.52.4 1.08.73 1.69.98l.38 2.65c.03.23.25.33.5.33h4c.24 0 .46-.1.5-.33l.38-2.65c.61-.25 1.17-.59 1.69-.98l2.49.85c.23.08.5-.01.61-.22l2-3.46c.12-.22.07-.49-.12-.64l-2.11-1.65z"/></svg>
                                            System Settings
                                        </Link>
                                    )}
