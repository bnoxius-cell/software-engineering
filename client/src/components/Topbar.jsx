...
const Topbar = ({ title }) => {
  return (
    <>
      {/* 1. The Header (Title & Profile) - This is sticky */}
      <header className="page-header sticky-header">
        <h1>{title}</h1>
        <a href="/" className="profile-link">
          <img className="avatar" src="/assets/images/profile_icon.png" alt="Admin Profile" />
        </a>
      </header>

      {/* 2. The Toolbar (Action Buttons & Search) - This scrolls normally */}
      <section className="toolbar">
        ...
        <div className="search-bar">
            <input type="text" className="input-field" placeholder="Search users..." disabled />
